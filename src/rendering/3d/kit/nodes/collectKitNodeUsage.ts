...
} from '../attachments/Toa Metru/matau';
import {
...
import { RAHKSHI_KIT_2001_ATTACHMENTS, RAHKSHI_KIT_2003_ATTACHMENTS } from '../attachments/rahkshi';
import {
...
export const KIT_2001_NODE_EXEMPT: readonly Kit2001NodeName[] = [
  ...
  // Rebuilt Matoran now ship packed `Body` instead of cloning this foot.
...
export const KIT_2003_NODE_EXEMPT: readonly Kit2003NodeName[] = [
  // Rebuilt Matoran now ship packed `Body` instead of cloning these.
