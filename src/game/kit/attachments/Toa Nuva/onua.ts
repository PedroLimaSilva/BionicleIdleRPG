...
export const ONUA_NUVA_KIT_2003_ATTACHMENTS: Record<string, KitSocketAttachment> = {
  ...
  BohrokArmL: { kitNodeName: 'BohrokArm', materialColors: { Main: ONUA_NUVA_PALETTE_COLORS.Secondary } },
  BohrokArmR: { kitNodeName: 'BohrokArm', materialColors: { Main: ONUA_NUVA_PALETTE_COLORS.Secondary } },
