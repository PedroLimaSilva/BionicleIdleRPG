...
export const LEWA_NUVA_KIT_2001_ATTACHMENTS: Record<string, Kit2001SocketAttachment> = {
  ...
  AxleModHips: { kitNodeName: KIT_2001_NODES.AxleModHips, materialColors: LEWA_NUVA_PALETTE_COLORS },
  AxleSocket1L: { kitNodeName: KIT_2001_NODES.AxleSocket1L, materialColors: LEWA_NUVA_PALETTE_COLORS },
  AxleSpacer1LB: { kitNodeName: KIT_2001_NODES.AxleSpacer1L, materialColors: LEWA_NUVA_PALETTE_COLORS },
  AxleSpacer1LF: { kitNodeName: KIT_2001_NODES.AxleSpacer1L, materialColors: LEWA_NUVA_PALETTE_COLORS },
  ...
  MataAbdomen: { kitNodeName: KIT_2001_NODES.MataAbdomen, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataBrain: {
  ...
  MataLegModShinL: { kitNodeName: KIT_2001_NODES.MataLegModShin, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataLegModShinR: { kitNodeName: KIT_2001_NODES.MataLegModShin, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataLegModThighL: { kitNodeName: KIT_2001_NODES.MataLegModThigh, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataLegModThighR: { kitNodeName: KIT_2001_NODES.MataLegModThigh, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataObliqueNL: { kitNodeName: KIT_2001_NODES.MataObliqueN, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataObliqueNR: { kitNodeName: KIT_2001_NODES.MataObliqueN, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataObliqueWL: { kitNodeName: KIT_2001_NODES.MataObliqueW, materialColors: LEWA_NUVA_PALETTE_COLORS },
  MataObliqueWR: { kitNodeName: KIT_2001_NODES.MataObliqueW, materialColors: LEWA_NUVA_PALETTE_COLORS },
...
export const LEWA_NUVA_KIT_2003_ATTACHMENTS: Record<string, Kit2003SocketAttachment> = {
  ...
  NuvaPistonNL: { kitNodeName: KIT_2003_NODES.NuvaPistonN, materialColors: LEWA_NUVA_PALETTE_COLORS },
  NuvaPistonNR: { kitNodeName: KIT_2003_NODES.NuvaPistonN, materialColors: LEWA_NUVA_PALETTE_COLORS },
  NuvaPistonTL: { kitNodeName: KIT_2003_NODES.NuvaPistonT, materialColors: LEWA_NUVA_PALETTE_COLORS },
  NuvaPistonTR: { kitNodeName: KIT_2003_NODES.NuvaPistonT, materialColors: LEWA_NUVA_PALETTE_COLORS },
