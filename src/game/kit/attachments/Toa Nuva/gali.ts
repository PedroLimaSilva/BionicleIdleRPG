...
export const GALI_NUVA_KIT_2001_ATTACHMENTS: Record<string, Kit2001SocketAttachment> = {
  ...
  AxleModHips: { kitNodeName: KIT_2001_NODES.AxleModHips, materialColors: GALI_NUVA_PALETTE_COLORS },
  ...
  AxleSocket1L: { kitNodeName: KIT_2001_NODES.AxleSocket1L, materialColors: GALI_NUVA_PALETTE_COLORS },
  AxleSpacer1LB: { kitNodeName: KIT_2001_NODES.AxleSpacer1L, materialColors: GALI_NUVA_PALETTE_COLORS },
  AxleSpacer1LF: { kitNodeName: KIT_2001_NODES.AxleSpacer1L, materialColors: GALI_NUVA_PALETTE_COLORS },
  ...
  MataAbdomen: { kitNodeName: KIT_2001_NODES.MataAbdomen, materialColors: GALI_NUVA_PALETTE_COLORS },
  MataBrain: {
  ...
  MataObliqueNL: { kitNodeName: KIT_2001_NODES.MataObliqueN, materialColors: GALI_NUVA_PALETTE_COLORS },
  MataObliqueNR: { kitNodeName: KIT_2001_NODES.MataObliqueN, materialColors: GALI_NUVA_PALETTE_COLORS },
  MataObliqueWL: { kitNodeName: KIT_2001_NODES.MataObliqueW, materialColors: GALI_NUVA_PALETTE_COLORS },
  MataObliqueWR: { kitNodeName: KIT_2001_NODES.MataObliqueW, materialColors: GALI_NUVA_PALETTE_COLORS },
...
export const GALI_NUVA_KIT_2003_ATTACHMENTS: Record<string, Kit2003SocketAttachment> = {
  AquaAxeL: { kitNodeName: KIT_2003_NODES.AquaAxe, materialColors: GALI_NUVA_AQUA_AXE_PALETTE_COLORS },
  AquaAxeR: { kitNodeName: KIT_2003_NODES.AquaAxe, materialColors: GALI_NUVA_AQUA_AXE_PALETTE_COLORS },
  Axle3LStudL: {
  ...
  AxleSpacer12L: { kitNodeName: KIT_2003_NODES.AxleSpacerHalf, materialColors: GALI_NUVA_PALETTE_COLORS },
  AxleSpacer12R: { kitNodeName: KIT_2003_NODES.AxleSpacerHalf, materialColors: GALI_NUVA_PALETTE_COLORS },
  ...
  NuvaForearmL: { kitNodeName: KIT_2003_NODES.NuvaForearm, materialColors: GALI_NUVA_PALETTE_COLORS },
  NuvaForearmR: { kitNodeName: KIT_2003_NODES.NuvaForearm, materialColors: GALI_NUVA_PALETTE_COLORS },
  NuvaPistonNL: { kitNodeName: KIT_2003_NODES.NuvaPistonN, materialColors: GALI_NUVA_PALETTE_COLORS },
  NuvaPistonNR: { kitNodeName: KIT_2003_NODES.NuvaPistonN, materialColors: GALI_NUVA_PALETTE_COLORS },
  NuvaPistonTL: { kitNodeName: KIT_2003_NODES.NuvaPistonT, materialColors: GALI_NUVA_PALETTE_COLORS },
  NuvaPistonTR: { kitNodeName: KIT_2003_NODES.NuvaPistonT, materialColors: GALI_NUVA_PALETTE_COLORS },
  ...
  NuvaTricepsL: { kitNodeName: KIT_2003_NODES.NuvaTriceps, materialColors: GALI_NUVA_PALETTE_COLORS },
  NuvaTricepsR: { kitNodeName: KIT_2003_NODES.NuvaTriceps, materialColors: GALI_NUVA_PALETTE_COLORS },
  PropellerL: { kitNodeName: KIT_2003_NODES.Propeller, materialColors: GALI_NUVA_PROPELLER_PALETTE_COLORS },
  PropellerR: { kitNodeName: KIT_2003_NODES.Propeller, materialColors: GALI_NUVA_PROPELLER_PALETTE_COLORS },
};
