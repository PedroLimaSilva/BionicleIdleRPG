...
export const LEWA_MATA_KIT_2001_ATTACHMENTS: Record<string, KitSocketAttachment> = {
  ...
  AxleMod2L: { kitNodeName: 'AxleMod2L', materialColors: LEWA_MATA_KIT_PALETTE_COLORS },
  ...
  AxleSocket1L: { kitNodeName: 'AxleSocket1L', materialColors: LEWA_MATA_KIT_PALETTE_COLORS },
  ...
  GearB: { kitNodeName: 'GearB', materialColors: LEWA_MATA_KIT_PALETTE_COLORS },
