...
export const REBUILT_KIT_2001_ATTACHMENTS: Record<string, Kit2001SocketAttachment> = {
  ...
  AxleSpacer: { kitNodeName: KIT_2001_NODES.AxleSpacer1L, materialColors: MATORAN_KIT_PALETTE_METAL },
  ...
  McToranFace: { kitNodeName: KIT_2001_NODES.McToranFace, materialColors: MATORAN_KIT_PALETTE_FACE },
...
export const REBUILT_KIT_2003_ATTACHMENTS: Record<string, Kit2003SocketAttachment> = {
  ...
  LegL: { kitNodeName: KIT_2003_NODES.PerpendicularLiftArm, materialColors: MATORAN_KIT_PALETTE_FEET },
  LegR: { kitNodeName: KIT_2003_NODES.PerpendicularLiftArm, materialColors: MATORAN_KIT_PALETTE_FEET },
  MatoranBody: { kitNodeName: KIT_2003_NODES.MatoranBody, materialColors: MATORAN_KIT_PALETTE_BODY },
  TechnicTorsoPivot: {
