 ...
 * Onewa has its own model; merge the remaining Toa Metru PRs to clear this list.
 */
export const TOA_METRU_NUJU_RIG_IDS = ['Toa_Nokama', 'Toa_Vakama', 'Toa_Whenua'] as const;
