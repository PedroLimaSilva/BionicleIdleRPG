...
export const RECRUITABLE_MATORAN: Matoran[] = [
  {
    id: 2,
    name: 'Jala',
    mask: Mask.Hau,
...
export const MATORAN_INVENTORY: Matoran[] = [
  {
    id: 1,
    name: 'Takua',
    mask: Mask.Pakari,
...
export function getMatoranFromInventoryById(id: Matoran['id']) {
  return MATORAN_INVENTORY.find((m) => m.id === id);
}
