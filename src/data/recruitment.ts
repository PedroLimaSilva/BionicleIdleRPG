...
export const RECRUITMENT_REGISTRY: RecruitmentEntry[] = [
  ...
  { id: 'Kapura', cost: 750, unlockedByQuest: 'mnog_takua_meets_kapura' },
  { id: 'Jala', cost: 2000, unlockedByQuest: 'mnog_tahu_unlock_01' },
  { id: 'Hahli', cost: 1000, unlockedByQuest: 'mnog_restore_ga_koro' },
  { id: 'Hafu', cost: 500, unlockedByQuest: 'mnog_po_wahi_desert' },
  { id: 'Kivi', cost: 750, unlockedByQuest: 'mnog_po_koro_sickness' },
  { id: 'Huki', cost: 1000, unlockedByQuest: 'mnog_recruit_hewkii' },
  { id: 'Maku', cost: 600, unlockedByQuest: 'mnog_recruit_hewkii' },
  { id: 'Nuparu', cost: 1000, unlockedByQuest: 'mnog_arrive_onu_koro' },
  { id: 'Onepu', cost: 600, unlockedByQuest: 'mnog_arrive_onu_koro' },
  { id: 'Taipu', cost: 600, unlockedByQuest: 'mnog_meet_taipu' },
  { id: 'Tamaru', cost: 600, unlockedByQuest: 'mnog_flight_to_hive' },
  { id: 'Kongu', cost: 1000, unlockedByQuest: 'mnog_flight_to_hive' },
  { id: 'Kopeke', cost: 600, unlockedByQuest: 'mnog_arrive_ko_koro' },
  { id: 'Lumi', cost: 750, unlockedByQuest: 'mnog_arrive_ko_koro' },
  { id: 'Matoro', cost: 1000, unlockedByQuest: 'mnog_search_for_matoro' },
  // Bohrok Swarm
