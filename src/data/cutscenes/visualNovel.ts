...
export const VISUAL_NOVEL_CUTSCENES: Record<string, VisualNovelCutscene> = {
    ...
    steps: [
      {
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `Takua! The match starts any second! Where have you BEEN?!`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `I found something, Jaller. In the lava tunnels under the Wall of History. There was a totem, and then this earthquake hit, and then this mask just... rose out of the lava. It was glowing, Jaller. Glowing like nothing I've ever seen.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `You were lava surfing AGAIN? You nearly got killed, didn't you? If Tahu hadn't shielded us—`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `Details, details. Look, I stuffed the mask in my pack. We'll figure it out later. Let's play some Kolhii!`,
      },
      {
        type: 'narration',
        text: `The newly built Kolhii field of Ta-Koro is packed. Three teams take the field: Jaller and Takua for Ta-Koro, Hewkii and Hafu for Po-Koro, and Hahli and Macku for Ga-Koro. The Toa Nuva watch from the stands as honorary guests.`,
      },
      {
        type: 'narration',
        text: `The match is fierce and fast. Hewkii hammers shot after shot with devastating power. Jaller defends brilliantly, but Takua keeps losing focus—staring at his pack, where the golden mask pulses faintly. Ta-Koro falls behind.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Hahli',
        portraitType: 'avatar',
        position: 'left',
        text: `Eyes on the ball, Takua!`,
      },
      {
        type: 'narration',
        text: `In the final round, Hahli catches a rebound off Hewkii's shot and drives it home with a clean, powerful strike. The crowd erupts. Ga-Koro wins.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Huki',
        portraitType: 'avatar',
        position: 'right',
        text: `Good match, Hahli. You've gotten better since the last tournament.`,
      },
    ],
  },
  ...
  mol_avohkii_discovery: {
    ...
    steps: [
      {
        type: 'narration',
        text: `As the crowd celebrates Ga-Koro's victory, the golden mask tumbles from Takua's pack onto the Kolhii field. Its radiance silences the stadium. A beam of light erupts upward, then sweeps across the crowd—and locks onto Takua.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Turaga_Vakama',
        portraitType: 'avatar',
        position: 'left',
        text: `It cannot be... the Avohkii! The Great Mask of Light!`,
      },
      {
        type: 'dialogue',
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `There is a prophecy inscribed on the mask, in the old language. It reads: "Among those assembled, a great spirit shall be revealed."`,
      },
      {
        type: 'dialogue',
        speakerId: 'Turaga_Vakama',
        portraitType: 'avatar',
        position: 'left',
        text: `A seventh Toa will arise—a Toa of Light—to challenge the darkness and awaken the Great Spirit. The mask has chosen its herald. Its light falls upon... Takua.`,
      },
      {
        type: 'narration',
        text: `Every eye in the stadium turns to Takua. The light is unmistakable. But Takua scoops the mask onto his Kolhii stick and angles it toward Jaller.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `I... I think it was actually pointing at Jaller. He was right next to me! Look—see? It's shining on him now!`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
      ...
      },
      {
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `Very well. Jaller—you are named Herald of the Seventh Toa. Take the Mask of Light. Follow where its beam leads. Find the Seventh Toa before Makuta learns of this discovery.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `The Seventh Toa? Turaga, are you sure? We Toa Nuva are more than enough to handle Makuta.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Turaga_Vakama',
        portraitType: 'avatar',
        position: 'left',
        text: `Some destinies, Tahu, are not yours to fulfill. The prophecy is clear.`,
      },
    ],
  },
    ...
    steps: [
      {
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `You're coming with me, Takua. You found the mask. You know more about it than anyone.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `Me? No, I'm just the Chronicler. I record things. I don't DO them.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `You do plenty. You just pretend you don't. Come on—Pewku's loaded and the mask is pointing south toward Le-Wahi.`,
      },
      {
        type: 'narration',
        text: `Jaller pauses at the gate of Ta-Koro. He takes his Hau mask and holds it out to Hahli.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `Hold onto this for me. I'll want it back when I return.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Hahli',
        portraitType: 'avatar',
        position: 'right',
        text: `You'd better come back, Jaller. I still owe you a rematch.`,
      },
      {
        type: 'narration',
        text: `The jungle of Le-Wahi closes around them. Vines as thick as Toa arms, canopy so dense the sun vanishes. Without warning, a Graalok ash bear crashes through the undergrowth, roaring. The massive Rahi rears over Takua and Jaller, claws raised.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Lewa_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Easy, big one. Easy. No need for ragefierce. They are friends.`,
      },
      {
        type: 'narration',
        text: `Lewa drops from the canopy and calms the ash bear with gentle air currents, guiding it away. But Tahu arrives moments later, blade drawn, furious.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `This quest is a waste of time. These two Matoran should be safe in a village, not stumbling through the jungle with a mask they don't understand.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Lewa_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `The Turaga gave them this duty, brother. Who are we to questionjudge?`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `I am Tahu Nuva. I question what I choose to question.`,
      },
      {
        type: 'narration',
        text: `Tahu storms off into the jungle. Lewa watches him go, then turns to the two Matoran with a shrug.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Lewa_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Pay him no heedmind. Keep following the mask. I think you are closer to the truth than any of us.`,
      },
    ],
  },
  ...
  mol_rahkshi_attack_ta_koro: {
    ...
    steps: [
      {
        type: 'narration',
        text: `Deep in Mangaia, Makuta stirs. He feels it—the Avohkii, the cursed Mask of Light, found at last. He reaches into the shadows and draws out three writhing kraata slugs. One by one, he drops them into vats of energized protodermis.`,
      },
      {
        type: 'narration',
        text: `Three Rahkshi crawl from the vats, their armor still dripping. Guurahk, the disintegrator. Lerahk, the poisoner. Panrahk, the fragmenter. Makuta's sons. He sends them to the surface with a single command: find the mask. Destroy the herald.`,
      },
      {
        type: 'narration',
        text: `At Kini-Nui, the Suva dome explodes outward. Gali Nuva, meditating within, is hurled aside as three Rahkshi burst from the ground. She barely escapes their combined blasts and races toward Ta-Koro to warn the others.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Gali_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Tahu! Three creatures—unlike anything we've fought—they destroyed the Suva! They're coming across the lake!`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `Let them come. This is my village.`,
      },
      {
        type: 'narration',
        text: `Panrahk's fragmentation blast tears through the gates. The Rahkshi storm into Ta-Koro, overturning everything in their search for the Avohkii—which is already gone, carried by Takua and Jaller into the jungle.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `The mask isn't here! Stop destroying my village!`,
      },
      {
        type: 'narration',
        text: `The Rahkshi do not listen. Guurahk's staff disintegrates the central supports. The stone platforms crack. The lava moat surges upward. Ta-Koro—home of the fire Matoran since the great migration—groans, splits apart, and sinks into the Lake of Fire.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
      ...
      },
      {
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `The Matoran are safe. That's what matters. But these creatures... they will answer for this. I swear it.`,
      },
    ],
  },
  ...
  mol_ko_wahi_ambush: {
    ...
    steps: [
      {
        type: 'narration',
        text: `The mask's light leads deeper into Ko-Wahi. Takua, Jaller, and Pewku reach a vast frozen lake high in the mountains. Kopaka Nuva stands at its edge, scanning the ridgeline with his Akaku.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Kopaka_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `You should not have come here. I sense movement beneath the ice. Something is tracking you.`,
      },
      {
        type: 'narration',
        text: `The ice erupts. Three new Rahkshi—Kurahk, Turahk, and Vorahk—burst from below, joining the hunt. Makuta has sent reinforcements. Six Rahkshi now pursue the Mask of Light.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `Three more of them! Kopaka—!`,
      },
      {
        type: 'narration',
        text: `Kopaka throws himself between the Matoran and the Rahkshi. He fights alone against three, his ice blade deflecting staff strikes. But the Rahkshi are too many. Vorahk drains his energy. Kurahk shatters his defenses. Takua slips on the cracking ice and plunges into the freezing water below.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `I can't... I can't feel my hands...`,
      },
      {
        type: 'narration',
        text: `Kopaka refreezes the lake surface, trapping the Rahkshi momentarily. He hauls Takua from the water with the last of his strength, then collapses. The Toa of Ice is battered and drained—but alive.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Kopaka_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Go. The ice will not hold them for long. Find the seventh Toa. It is the only way this ends.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
      ...
      },
      {
        ...
        portraitType: 'avatar',
        position: 'right',
        text: `That was not a request, Matoran. Go. Now.`,
      },
    ],
  },
  ...
  mol_tahu_poisoned: {
    ...
    steps: [
      {
        type: 'narration',
        text: `Consumed by rage over Ta-Koro's destruction, Tahu Nuva hunts the Rahkshi alone. In a jungle clearing, he corners Lerahk—but the creature is faster than he expects. Its staff of poison catches Tahu across the arm. A tiny scratch. Barely a wound.`,
      },
      {
        type: 'narration',
        text: `But the kraata poison is not an ordinary venom. It is Makuta's shadow given liquid form. Within moments, dark veins crawl up Tahu's arm and across his Hau Nuva. His flames turn sickly green. His thoughts curdle.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Lewa_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Brother? Your eyes... they are going dark. That is no ordinary wound—`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `Get away from me! ALL of you! You're as useless as those Matoran! I should have led this hunt ALONE from the beginning!`,
      },
      {
        type: 'narration',
        text: `Tahu swings his magma swords at Lewa—not a feint, but a killing blow. Lewa barely dodges. The poison has taken Tahu's natural fury and twisted it into blind hatred.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Gali_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `It's Makuta's poison—it's feeding on his anger! Lewa, hold him down! Kopaka, I need you—freeze the wound while I flush it with water!`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Kopaka_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Hold him still. I only have one shot at this.`,
      },
      {
        type: 'narration',
        text: `Lewa wraps Tahu in a cyclone, pinning his arms. Kopaka drives a spike of ice directly into the wound. Gali channels a torrent of water through the frozen venom, shattering it from within. The dark veins shatter like glass. Tahu drops to his knees.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `What... what happened to me? I could hear myself—screaming at you—but I couldn't stop. It felt right. The anger felt TRUE.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Gali_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `That is how Makuta works. He does not need to defeat us. He only needs to turn us against each other. The darkness was always inside you, Tahu—he just gave it a voice.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `Then I will silence it. Thank you, brothers. Sister.`,
      },
    ],
  },
  ...
  mol_takua_destiny: {
    ...
    steps: [
      {
        type: 'narration',
        text: `Another village scarred. Onu-Koro's tunnels collapsed by Rahkshi. Ko-Wahi's ice fields shattered. Ta-Koro gone forever. Every place the Avohkii travels, the Rahkshi follow. Takua sits in silence by a dead campfire, staring at the golden mask in his hands.`,
      },
      {
        type: 'narration',
        text: `Slowly, deliberately, Takua sets the Avohkii on the ground and stands up. He turns to walk away.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
      ...
      },
      {
        ...
        portraitType: 'avatar',
        position: 'right',
        text: `No. Every village we've visited, every person we've met—the Rahkshi came for them because of us. Because of ME. I'm done, Jaller. Maybe if I leave the mask here, they'll stop.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `And then what? Makuta wins? You think he'll just stop because you gave up? He'll destroy everything! The mask is the only chance we have!`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `Then let someone else carry it! I'm not a Toa! I'm not a hero! I'm the Matoran who never stays in one place long enough to be useful! I wander, I get into trouble, and other people pay for it!`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `That is exactly why the mask chose you. You never stay in one place because you're always going where you're needed. You went to Ga-Koro when it was drowning. You flew into the Nui-Rama hive. You walked into Makuta's shadow when the Toa descended. You were ALWAYS running toward danger, Takua. Not away from it. That is who you are.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
      ...
      },
      {
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `So am I. But duty is not about being unafraid. It's about being afraid and doing what must be done anyway. That is what I learned in the Guard. That is what you taught me.`,
      },
      {
        type: 'narration',
        text: `Takua looks back at the Avohkii. Its light pulses steadily, warm and patient, as it has since the moment it rose from the lava.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `...All right. We keep going. But Jaller—if something happens to me—`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `Nothing is going to happen to you. I'll make sure of it.`,
      },
    ],
  },
  ...
  mol_battle_of_kini_nui: {
    ...
    steps: [
      {
        type: 'narration',
        text: `All six Rahkshi converge on Kini-Nui. The Toa Nuva stand at the ruined temple, weapons drawn. This time, there is no retreat. No splitting up. No arguments. Six Toa against six Rahkshi—with everything at stake.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `No more running. We finish this here. Together.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Pohatu_Nuva',
        portraitType: 'avatar',
        position: 'right',
        text: `About time. Let's show these things what unity really means.`,
      },
      {
        type: 'narration',
        text: `The battle is savage. Pohatu and Onua combine stone and earth to crush Panrahk under a landslide. Lewa and Kopaka bring down Guurahk in a storm of wind and ice that tears its armor apart. Gali drowns Lerahk in a torrent summoned from the river. Tahu faces Vorahk and Kurahk alone, his flames burning hotter than they ever have.`,
      },
      {
        type: 'narration',
        text: `Five Rahkshi fall. But the sixth—Turahk, the Rahkshi of Fear—slips past the Toa. It has one target. It sees Takua clutching the Avohkii at the edge of the battlefield and raises its staff.`,
      },
      {
        type: 'narration',
        text: `A bolt of pure, concentrated fear lances toward Takua. Time slows. Takua sees it coming but cannot move—the fear has already taken root, locking his limbs.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
      ...
      {
        type: 'narration',
        text: `Jaller throws himself in front of Takua. The blast of fear-energy strikes the Captain of the Guard full in the chest. He staggers. His knees buckle. He falls.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
      ...
      },
      {
        ...
        portraitType: 'avatar',
        position: 'left',
        text: `Takua... you know... who you are.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
        portraitType: 'avatar',
        position: 'left',
        text: `You were always... different.`,
      },
      {
        type: 'narration',
        text: `Jaller's heartlight flickers... and goes dark. The Captain of the Guard, the bravest Matoran on Mata Nui, lies still in Takua's arms. The battlefield falls silent. Even the last Rahkshi pauses.`,
      },
    ],
  },
  ...
  mol_takanuva_rises: {
    ...
    steps: [
      {
        type: 'narration',
        text: `Takua cradles Jaller's still form. The Avohkii lies between them, its light steady and unwavering—as it has been from the very beginning. Around them, the Toa Nuva lower their weapons. The battle is over. But Jaller is gone.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `You were always right, Jaller. From the moment the mask's light found me in the stadium, you knew. You knew and I wouldn't listen.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takua',
        portraitType: 'avatar',
        position: 'right',
        text: `I was the herald. But I wasn't searching for the Seventh Toa. I was running from him.`,
      },
      {
        type: 'narration',
        text: `Takua picks up the Avohkii. His hands no longer tremble. He lifts it to his face—and places it over his own mask.`,
      },
      {
        type: 'narration',
        text: `Light explodes outward. Not a beam—a wave. It washes over the ruined temple, over the Toa Nuva, over the fallen Rahkshi. Takua's body transforms. He grows taller. His armor reshapes into white and gold. His heartlight blazes with the brilliance of a star. Where a Matoran knelt in grief, a Toa now stands.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takanuva',
      ...
      {
        type: 'narration',
        text: `Takanuva turns on Turahk. The Rahkshi of Fear raises its staff—but the light pouring from Takanuva is absolute. There is no shadow left for fear to hide in. A single blast of radiance annihilates Turahk where it stands.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Toa_Tahu_Nuva',
        portraitType: 'avatar',
        position: 'left',
        text: `The seventh Toa. It was the Chronicler all along.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takanuva',
        portraitType: 'avatar',
        position: 'right',
        text: `Jaller gave his life so that I could accept mine. I will not waste it. Makuta—I'm coming for you.`,
      },
    ],
  },
  ...
  mol_defeat_of_makuta: {
    ...
    steps: [
      {
        type: 'narration',
        text: `From the shattered shells of the Rahkshi, Takanuva constructs the Ussanui—a vehicle powered by kraata slugs, built to carry him into the depths of Mangaia. He sets Jaller's mask upon the front, a memorial and a promise. Hahli insists on coming as the new Chronicler. There must be a witness.`,
      },
      {
        type: 'narration',
        text: `The Ussanui plunges through the tunnels beneath Kini-Nui, deeper than even the Toa have ventured. The walls grow darker. The air turns cold. At last, the vehicle crashes through a stone barrier and skids to a halt in a vast, lightless chamber. Mangaia—Makuta's lair.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Makuta',
        portraitType: 'avatar',
        position: 'left',
        text: `So. The Matoran has become a Toa. How... amusing. You think your light can challenge my shadow? Shadow is the absence of light. You cannot destroy what you define.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takanuva',
        portraitType: 'avatar',
        position: 'right',
        text: `I am not afraid of you, Makuta. Not anymore.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Makuta',
        portraitType: 'avatar',
        position: 'left',
        text: `Then let us settle this in the manner of your people. A game of Kolhii. If you win, you may try to open the gate behind me. If you lose... I take the Avohkii, and your light dies forever.`,
      },
      {
        type: 'narration',
        text: `Makuta summons a staff of pure shadow. Takanuva grips his staff of light. The field: stone pillars rising over a pool of silver energized protodermis. The ball: alternating spheres of light and shadow energy, hurled with devastating force.`,
      },
      {
        type: 'narration',
        text: `They play. It is the most brutal game of Kolhii ever played. Pillars shatter. The cavern shakes. Shadow swallows light, light burns through shadow. Neither gives ground. It is not a game—it is a war fought with the rules of sport.`,
      },
      {
        type: 'narration',
        text: `In the final exchange, Takanuva abandons the rules entirely. He charges Makuta, seizes him, and both plunge into the pool of energized protodermis below.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Hahli',
      ...
      {
        type: 'narration',
        text: `The pool erupts. From within rises a single towering figure—neither Toa nor Makuta, but both. Takutanuva. Light and shadow fused into one impossible being. Its voice is two voices speaking as one.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Takanuva',
      ...
      {
        type: 'narration',
        text: `Takutanuva reaches up and lifts the ancient gate—a door sealed since the Turaga brought the Matoran to the surface a thousand years ago. Its weight is immense, but the merged being holds it open.`,
      },
      {
        type: 'narration',
        text: `Hahli brings Jaller's body forward. Takutanuva touches the Captain's mask and channels a fraction of life energy into it. Jaller's heartlight flickers... and ignites. He gasps. He lives.`,
      },
      {
        type: 'dialogue',
        speakerId: 'Jala',
      ...
      {
        type: 'narration',
        text: `The gate's weight becomes too much. Takutanuva's arms buckle. The gate crashes down. In the impact, Makuta's shadow is expelled and scattered. From the rubble, only one being reforms—Takanuva, the Toa of Light, weakened but alive. The way below is open. And beyond it, the faint glow of an ancient city.`,
      },
    ],
  },
